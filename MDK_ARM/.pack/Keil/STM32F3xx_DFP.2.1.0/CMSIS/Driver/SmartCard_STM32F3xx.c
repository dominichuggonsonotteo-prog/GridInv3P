...
/*! \page stm32f3_usart_smart CMSIS-Driver USART Setup in SmartCard mode
...
----------
  ...
  2. Configure pins PC4 and PA8 as USART1 peripheral alternative pins
...
-----------------
  1. Under Connectivity open \b USART1 Configuration:
     ...
     - <b>GPIO Settings</b>: review settings
          ...
          PA8      | USART1_CK     | n/a          | Alternate ..| Pull-up            | High        | n/a         |.
