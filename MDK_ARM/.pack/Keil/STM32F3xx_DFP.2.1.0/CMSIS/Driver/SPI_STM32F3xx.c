 ...
 * Project:      SPI Driver for STMicroelectronics STM32F3xx
 * --------------------------------------------------------------------------
...
/*! \page stm32f3_spi CMSIS-Driver SPI Setup 
...
The STM32CubeMX configuration for STMicroelectronics STM32303C-EVAL Board with steps for Pinout, Clock, and System Configuration are 
listed below. Enter the values that are marked \b bold.

Pinout tab
----------
  1. Configure peripheral
     - Peripherals \b SPI2: Mode=<b>Full-Duplex Master</b>, Hardware NSS Signal=<b>Disable</b>
  ...
  2. Configure pins PB14, PB15 and PF9 as SPI2 peripheral alternative pins
     ...
     - Click in chip diagram on pin \b PF9  and select \b SPI2_SCK
...
-----------------
  1. Under Connectivity open \b SPI2 Configuration:
     ...
     - \e optional <b>DMA Settings</b>: setup DMA transfers for Rx and Tx (DMA is optional)\n
       \b Add - Select \b SPI1_RX: Stream=DMA1 Channel 4, Direction=Peripheral to Memory, Priority=Low\n
          DMA Request Settings         | Label             | Peripheral | Memory
          :----------------------------|:------------------|:-----------|:-------------
          Mode: Normal                 | Increment Address | OFF        |\b ON
          .                            | Data Width        |\b Byte     | Byte
       \b Add - Select \b SPI1_TX: Stream=DMA1 Channel 5, Direction=Memory to Peripheral, Priority=Low\n
          DMA Request Settings         | Label             | Peripheral | Memory
          :----------------------------|:------------------|:-----------|:-------------
          Mode: Normal                 | Increment Address | OFF        |\b ON
          .                            | Data Width        |\b Byte     | Byte
