...
/*! \page stm32f3_uart CMSIS-Driver USART Setup in Asynchronous mode
...
----------
  ...
  2. Configure pins PC4 and PE1 as USART1 peripheral alternative pins
