 ...
 * Project:      I2C Driver for STMicroelectronics STM32F3xx
 * --------------------------------------------------------------------------
...
/*! \page stm32f3_i2c CMSIS-Driver I2C Setup
...
----------
  1. Configure peripheral
     - Peripherals \b I2C2: select=<b>I2C</b>

  2. Configure pins PF6 and PA10 as I2C2 peripheral alternative pins
     - Click in chip diagram on pin \b PF6  and select \b I2C2_SCL
     - Click in chip diagram on pin \b PA10 and select \b I2C2_SDA
...
-----------------
  1. Under Connectivity open \b I2C2 Configuration:
     ...
     - <b>NVIC Settings</b>: enable interrupts
          ...
          I2C2 event global interrupt / I2C wake-.. | \b ON   | 0                   | 0
          I2C2 error interrupt                      | \b ON   | 0                   | 0
