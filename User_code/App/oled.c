...
/**
  ...
  * @param  num: 要显示的数字
  * @param  len: 显示位数
  * @param  size2: 字体大小 (16表示8x16字体，否则为6x8)
  * @note   支持去除前导零显示
  */
...
/**
  ...
  * @param  y: 起始页坐标
  * @param  chr: 要显示的字符串
  * @param  Char_Size: 字体大小 (16表示8x16字体，否则为6x8)
  */
