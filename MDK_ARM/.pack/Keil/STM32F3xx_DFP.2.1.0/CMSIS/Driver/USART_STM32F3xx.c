 ...
 * Project:      USART Driver for STMicroelectronics STM32F3xx
 * --------------------------------------------------------------------------
...
/*! \page stm32f3_usart CMSIS-Driver USART Setup in Synchronous mode
...
----------
  ...
  2. Configure pins PA8, PC4 and PE1 as USART1 peripheral alternative pins
     - Click in chip diagram on pin \b PA8 and select \b USART1_CK
     - Click in chip diagram on pin \b PC4 and select \b USART1_TX
     - Click in chip diagram on pin \b PE1 and select \b USART1_RX
...
-----------------
  1. Under Connectivity open \b USART1 Configuration:
     ...
     - <b>NVIC Settings</b>: enable interrupts
          ...
          USART1 global interrupt / USART1 wake-..  | \b ON   | 0                   | 0
